...
public class GlobalController : MonoBehaviour
{
    ...
    public static bool IsDailyShown
    {
        get; set;
    }
    ...
    public void RateGame ()
    {
        ...
        {
            Application.OpenURL(Constants.AppURL);
        }
#elif UNITY_ANDROID
    ...
    {
        Application.OpenURL(Constants.StoreURL);
    }
    ...
    public static void LikePageFacebook (MissionSuccessEvent e)
    {
        ...
        Application.OpenURL(Constants.FacebookPageURL);
    }
