    ...
    public void LoadData()
    {
        ...
        if (string.IsNullOrEmpty(data))
        {
            Data = new GameData()
            {
                ...
                HeadsetUnlockProgress = new List<int>(new int[AssetController.Instance.ListWeaponSprites.Count])
            };
        }
        else
        {
        ...
        if (Data.HeadsetUnlockProgress.Count < AssetController.Instance.ListWeaponSprites.Count)
        {
            Data.HeadsetUnlockProgress.AddRange(new List<int>(new int[AssetController.Instance.ListWeaponSprites.Count - Data.HeadsetUnlockProgress.Count]));
        }
