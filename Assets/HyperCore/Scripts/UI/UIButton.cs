...
public class UIButton : UIBaseInteractive
{
    ...
    private void OnFingerDown()
    {
        ...
        pressedY = avatar.transform.localPosition.y;
        tweenColorID = LeanTween.color(avatar.rectTransform, pressedColor, 0.1f).setIgnoreTimeScale(true).id;
    ...
    private void OnFingerUp()
    {
        ...
        tweenColorID = LeanTween.color(avatar.rectTransform, StartColor, 0.1f).setIgnoreTimeScale(true).id;
